...
export function Hero() {
  return (
    <section className="relative min-h-[100dvh] bg-dark overflow-clip">
      ...
      <div className="pointer-events-none relative z-10 max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 min-h-[100dvh] flex flex-col justify-center pt-24 pb-32 lg:flex-row lg:items-center lg:pt-0 lg:pb-0">
